...
# App Services Linux war파일 배포 workflow.yaml
```
...
# App Services Windows war파일 배포 workflow.yaml
```
# Docs for the Azure Web Apps Deploy action: https://github.com/Azure/webapps-deploy
# More GitHub Actions for Azure: https://github.com/Azure/actions

name: Build and deploy JAR app to Azure Web App - os-Windows-as
  ...
  build:
    ...
    steps:
      ...
      - name: Deploy to Azure Web App
        ...
        uses: azure/webapps-deploy@v2
        with:
          app-name: 'os-Windows-as'
          slot-name: 'Production'
          publish-profile: ${{ secrets.AZUREAPPSERVICE_PUBLISHPROFILE_E98AA71A588C492B96D8F9DE0B69465D }}
          package: '${{ github.workspace }}/BLACKCODE/build/libs/ROOT.war'
```

# App Services Windows jar파일 배포 workflow.yaml
```
# Docs for the Azure Web Apps Deploy action: https://github.com/Azure/webapps-deploy
# More GitHub Actions for Azure: https://github.com/Azure/actions

name: Build and deploy JAR app to Azure Web App - FE-as
  ...
  build:
    ...
    steps:
      ...
      - name: Upload artifact for deployment job
        ...
        with:
          name: java-app
          path: '${{ github.workspace }}/demo-jar/build/libs/*.jar'
    ...
    steps:
      ...
      - name: Deploy to Azure Web App
        ...
        with:
          app-name: 'FE-as'
          slot-name: 'Production'
          publish-profile: ${{ secrets.AZUREAPPSERVICE_PUBLISHPROFILE_9A6D90381F33418D9AE49A5630C5CDD5 }}
          package: '*SNAPSHOT.jar' # 수정 : *.jar > SNAPSHOT.jar
```
